...
// QueryDetails queries the "details" edge of the Project entity.
func (pr *Project) QueryDetails() *ProjectDetailQuery {
	return NewProjectClient(pr.config).QueryDetails(pr)
}
