...
func (bcq *BlogCommentQuery) QueryBlogPost() *BlogPostQuery {
...
func (bcq *BlogCommentQuery) WithBlogPost(opts ...func(*BlogPostQuery)) *BlogCommentQuery {
	query := (&BlogPostClient{config: bcq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	bcq.withBlogPost = query
	return bcq
}
...
func (bcq *BlogCommentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*BlogComment, error) {
	...
	if query := bcq.withBlogPost; query != nil {
		if err := bcq.loadBlogPost(ctx, query, nodes, nil,
...
func (bcq *BlogCommentQuery) loadBlogPost(ctx context.Context, query *BlogPostQuery, nodes []*BlogComment, init func(*BlogComment), assign func(*BlogComment, *BlogPost)) error {
