...
var (
	...
	BlogPostsColumns = []*schema.Column{
		...
		{Name: "project_name", Type: field.TypeString, Nullable: true, Size: 500},
		{Name: "publication_venue", Type: field.TypeString, Nullable: true, Size: 300},
		{Name: "project_url", Type: field.TypeString, Nullable: true, Size: 1000},
		{Name: "external_resources", Type: field.TypeString, Nullable: true, Size: 2147483647},
	...
	ContentInteractionColumns = []*schema.Column{
		...
		{Name: "country_code", Type: field.TypeString, Nullable: true, Size: 2},
		{Name: "region_code", Type: field.TypeString, Nullable: true, Size: 16},
		{Name: "region_name", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "city", Type: field.TypeString, Nullable: true, Size: 120},
		{Name: "postal_code", Type: field.TypeString, Nullable: true, Size: 32},
		{Name: "place_name", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "place_feature_code", Type: field.TypeString, Nullable: true, Size: 16},
		{Name: "place_distance_km", Type: field.TypeFloat64, Nullable: true},
		{Name: "latitude", Type: field.TypeFloat64, Nullable: true},
		{Name: "longitude", Type: field.TypeFloat64, Nullable: true},
		{Name: "time_zone", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "accuracy_radius", Type: field.TypeInt, Nullable: true},
	...
	ContentInteractionTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{ContentInteractionColumns[28]},
			},
		},
	}
	...
	ProjectsColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeEnum, Enums: []string{"active", "completed", "paused", "cancelled", "archived"}, Default: "active"},
		{Name: "start_date", Type: field.TypeString, Nullable: true},
		{Name: "end_date", Type: field.TypeString, Nullable: true},
		{Name: "github_url", Type: field.TypeString, Nullable: true, Size: 500},
		{Name: "demo_url", Type: field.TypeString, Nullable: true, Size: 500},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{RequestLogsColumns[23]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{RequestLogsColumns[21]},
			},
		},
	}
