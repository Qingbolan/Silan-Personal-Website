...
func (cc *CommentCreate) SetAuthorEmail(s string) *CommentCreate {
	cc.mutation.SetAuthorEmail(s)
	return cc
}
...
func (cc *CommentCreate) SetNillableAuthorWebsite(s *string) *CommentCreate {
	if s != nil {
		cc.SetAuthorWebsite(*s)
	}
	return cc
}
...
func (cc *CommentCreate) SetNillableIsApproved(b *bool) *CommentCreate {
	if b != nil {
		cc.SetIsApproved(*b)
	}
	return cc
...
func (cc *CommentCreate) SetUserIdentityID(s string) *CommentCreate {
	cc.mutation.SetUserIdentityID(s)
	return cc
}

// SetNillableUserIdentityID sets the "user_identity_id" field if the given value is not nil.
func (cc *CommentCreate) SetNillableUserIdentityID(s *string) *CommentCreate {
	if s != nil {
		cc.SetUserIdentityID(*s)
	}
	return cc
}

// SetLikesCount sets the "likes_count" field.
func (cc *CommentCreate) SetLikesCount(i int) *CommentCreate {
	cc.mutation.SetLikesCount(i)
	return cc
}

// SetNillableLikesCount sets the "likes_count" field if the given value is not nil.
func (cc *CommentCreate) SetNillableLikesCount(i *int) *CommentCreate {
	if i != nil {
		cc.SetLikesCount(*i)
	}
	return cc
...
func (cc *CommentCreate) SetUserIdentity(u *UserIdentity) *CommentCreate {
	return cc.SetUserIdentityID(u.ID)
}
...
func (cc *CommentCreate) check() error {
	...
	if v, ok := cc.mutation.AuthorName(); ok {
	...
	if v, ok := cc.mutation.AuthorWebsite(); ok {
...
func (cc *CommentCreate) createSpec() (*Comment, *sqlgraph.CreateSpec) {
	...
	if nodes := cc.mutation.UserIdentityIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
